...
class Block:
    def __init__(self, canvas, x, y, color):
        ...
        self.pos_x = x
        self.pos_y = y
        self.id = canvas.create_rectangle(0, 0, 30, 10, fill=color,outline='white')
...
BALL_SPEED = 5
PADDLE_SPEED = 3
COLORS = ('alice blue', 'aquamarine', 'blue')
...
paddle = Paddle(canvas, PADDLE_SPEED, 'orange')
ball = Ball(canvas, paddle, score, blocks, BALL_SPEED, 'red')
gameover = Gameover(canvas, 275, 275, "G A M E O V E R", 50, 'blue')
